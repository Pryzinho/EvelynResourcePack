...
public class Titles {
    ...
    public static void sendTitle(Player player, String title, String subtitle, Integer fadeIn, Integer stay,
                                 Integer fadeOut) {
        try {
            if (title != null) {
    ...
    public void clearTitle(Player player) {
        try {
            ...
            Object packet = this.packetTitle.getConstructor(new Class[] { this.packetActions, this.chatBaseComponent })
