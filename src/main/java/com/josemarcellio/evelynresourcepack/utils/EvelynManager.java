...
public class EvelynManager {
    ...
    public static void Listener() {
        Main.getPlugins().getServer ().getPluginManager ().registerEvents ( new ResourcePack (Main.getPlugins(), new EvelynHandler (Main.getPlugins())), Main.getPlugins() );
        Main.getPlugins().getServer ().getPluginManager ().registerEvents ( new PlayerWalk (Main.getPlugins(), new EvelynHandler (Main.getPlugins())), Main.getPlugins() );
        Main.getPlugins().getServer ().getPluginManager ().registerEvents ( new PlayerQuit (Main.getPlugins(), new EvelynHandler (Main.getPlugins())), Main.getPlugins() );
        if (Main.getPlugins().getServer ().getPluginManager ().isPluginEnabled ( "AuthMe" )) {
            Main.getPlugins().getLogger ().info ( "Hooking to AuthMe!" );
            Main.getPlugins().getServer ().getPluginManager ().registerEvents ( new AuthMeListener (Main.getPlugins()), Main.getPlugins() );
            ...
            Main.getPlugins().getServer ().getPluginManager ().registerEvents ( new nLoginListener (Main.getPlugins()), Main.getPlugins() );
            ...
            Main.getPlugins().getServer ().getPluginManager ().registerEvents ( new OpeNLoginListener (Main.getPlugins()), Main.getPlugins() );
        } else {
            Main.getPlugins().getServer ().getPluginManager ().registerEvents ( new PlayerJoin (Main.getPlugins()), Main.getPlugins() );
            Main.getPlugins().getLogger ().info("No Login Plugins Found!, Use Default System!");
        }
    }
    public static void Command() {
        Objects.requireNonNull ( Main.getPlugins ().getCommand ( "pack" ) ).setExecutor ( new ResourcePackCommand (Main.getPlugins()) );
        Objects.requireNonNull ( Main.getPlugins ().getCommand ( "resourcepack" ) ).setExecutor ( new MainCommand (Main.getPlugins()) );
    }
}
